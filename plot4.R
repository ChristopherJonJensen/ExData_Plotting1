...
plot4 <- function (){ 
    ...
    plot(plotData$Voltage, type = "l", ylab = "Voltage", xaxt = "n", xlab = "datetime")
    axis(side=1,at=c(0,1440,2880),labels=c("Thu","Fri","Sat"))
    ...
    plot(plotData$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xaxt = "n", xlab = "datetime")
    axis(side=1,at=c(0,1440,2880),labels=c("Thu","Fri","Sat"))
